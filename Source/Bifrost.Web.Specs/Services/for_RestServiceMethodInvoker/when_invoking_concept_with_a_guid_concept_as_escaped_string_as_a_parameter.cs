...
{
    public class when_invoking_concept_with_a_guid_concept_as_escaped_string_as_a_parameter : given.a_rest_service_method_invoker_and_a_service_call_for_guid_concept_input_and_no_output
    {
